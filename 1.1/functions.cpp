...
void skaitytiDuomenisIsVartotojo(std::list<Student>& studentai) {
    ...
    for (int i = 0; i < studentuKiekis; ++i) {
        ...
        if (pasirinkimas == '1') {
            ...
            std::list<int> nd;
            int ndBalas;
            std::cout << "Iveskite namu darbu pazymius (iveskite -1, jei norite baigti): " << std::endl;
...
void spausdintiStudentus(const std::list<Student>& studentai) {
    std::cout << std::setw(15) << std::left << "Vardas"
              ...
              << std::setw(25) << std::left << "Adresas atmintyje" << std::endl;
    std::cout << "-------------------------------------------------------------------------------------------" << std::endl;
    ...
    for (const auto& student : studentai) {
        std::cout << std::setw(15) << std::left << student.getVardas()
                  << std::setw(15) << std::left << student.getPavarde()
                  << std::setw(20) << std::left << std::fixed
                  << std::setprecision(2) << student.getGalutinisVid()
                  << std::setw(20) << std::left << std::fixed
                  << std::setprecision(2) << student.getGalutinisMed()
                  << std::setw(25) << std::left << &student << std::endl;
    }
}
