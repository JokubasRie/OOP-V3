...
int main() {
    ...
    if (mainChoice == '1') {
        ...
        try {
            ...
            // Rūšiuojame studentus pagal vardą
            sort(studentai.begin(), studentai.end(), compareByName);

            // Dalijame į „vargsiukus“ ir „kietiakus“ pagal antrąją strategiją
            vector<Student> vargsiukai;
            rusiuotiStudentus(studentai, vargsiukai);

            // Dabar „studentai“ vektoriuje liko tik „kietiakai“, o „vargsiukai“ yra atskirame vektoriuje
            char calcChoice;
